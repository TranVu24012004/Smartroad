...
model_path = r'/home/vu/Downloads/Smartroad/BACKEND/models/best.pt'
...
vit_model.load_state_dict(torch.load(r'/home/vu/Downloads/Smartroad/BACKEND/models/best_vit_multi_label.pth', map_location=device))
